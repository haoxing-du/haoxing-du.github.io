...
Given this, it might appear that the ontic status of the quantum state is the overwhelming consensus, and the answer to our question is clear. However, below I will make the case that $\psi$-onticity might be a problematic premise that has been widely internalized without good reasons---like that of the ideographic nature of the Egyptian hieroglyphs. I will make this case from two angles: first, why $\psi$-onticity is problematic from the standpoint of locality, and second, why there appears to be strong evidence for the epistemic nature of the quantum state.
